...
function bmi (weight, height) {
    ...
    if (bmi1 >= 20 && bmi1 <= 30) {
        console.log(`Category is under weight and bmi is   ${bmi1}`);
    } else if (bmi1 >= 31 && bmi1 <=40) {
        console.log(`Category is NORMAL weight and bmi is ${bmi1}`);
    } else if (bmi1 >= 41) {
        console.log(`Category is OVER weight and bmi is ${bmi1}`);
    } else {
